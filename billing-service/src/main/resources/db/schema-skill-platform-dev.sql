-- =====================================================================
-- dev 单库联调：skill_platform 表（与 skill-gateway/src/main/resources/db/
-- schema-skill-platform.sql 保持同源同步；生产分库时本文件不参与 prod init）
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS `skill_version` (
    ...
    `oss_key`         VARCHAR(512) NOT NULL                COMMENT 'skill/{tenantId}/{skillCode}/{version}/skill.zip',
